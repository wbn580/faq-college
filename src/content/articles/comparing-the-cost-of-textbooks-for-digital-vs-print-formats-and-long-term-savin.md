...
1. **Buy used print** for STEM and major-specific courses (higher comprehension needs). Net cost per book: $40-$60 after resale.
2. **Rent digital** for general education and elective courses (lower stakes). Net cost per book: $43.
3. **Use OER** whenever available. Check OpenStax.org for free, peer-reviewed digital textbooks in 30+ subjects.
4. **Share with classmates** for courses with identical syllabi. Splitting a $105 print book three ways costs $35 each.
5. **Sell print books immediately** after finals. Campus buyback prices drop 10-20% per week after the semester ends (NACS, 2023).
