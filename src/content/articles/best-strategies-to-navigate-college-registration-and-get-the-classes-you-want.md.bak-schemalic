...
1. Identify all sections of each required course (check the course catalog for section numbers and times).
2. Rank them by preference (time, professor rating, location).
3. Register for your top section — if it is full, immediately move to your second choice.
4. Use the waitlist for your top choice only if the second choice is confirmed.
